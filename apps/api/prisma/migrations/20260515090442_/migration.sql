...
-- CreateEnum
CREATE TYPE "NotificationType" AS ENUM ('TASK_ASSIGNED', 'TASK_UPDATED', 'TASK_COMMENTED', 'PROJECT_INVITE', 'WORKSPACE_INVITE', 'MENTION');

-- CreateEnum
CREATE TYPE "ActivityAction" AS ENUM ('CREATED', 'UPDATED', 'DELETED', 'ASSIGNED', 'COMMENTED', 'STATUS_CHANGED', 'JOINED', 'LEFT', 'INVITED');
